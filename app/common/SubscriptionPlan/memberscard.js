...
import Trash from "../../assets/icon/trashWhite.svg";
import { useState } from "react";
import RemoveDependantDialog from "../Dialogs/removeDependantDialog";
...
export default function MembersCard({
  ...
  console.log(JSON.stringify(membersData) + " Members...");

  const user_name = useSelector((state) => state.operation?.user_name);
  const handleRemoveDependant = (dependent_id) => {
    console.log(dependent_id, "ksjdepe");
    setAlertOn({
      isOn: true,
      dependent_id,
    });
  ...
  return (
    <>
              ...
              >
                ...
                <View>
                  <Text style={styles.title}>
                    {data?.f_name ? data?.f_name : user_name}
                  </Text>
                </View>
              </View>
              <View></View>
      ...
      {members?.map((item) => {
        console.log(item?.user_id, "memebkjbdj");
        return (
          <>
                    ...
                    >
                      <View style={styles.txtcontainer}>
                        <Text style={styles.name}>
                          {item?.is_accepted == 1 ? "linked" : "invite sent"}
                        </Text>
                      </View>
                      <View>
                        <Text style={styles.title}>{item?.name}</Text>
                        {/* <Text style={styles.sub_title}>{"("}{item?.range_limit}{")"}</Text> */}
                      </View>
                    </View>
                    <View></View>
                  </View>
                    ...
                    <View>
                      ...
                      >
                        <Text style={styles.pricetxt}>
                          {"+RM"}
                          {item?.subscription_master?.price}
                        </Text>
                      </View>
                      <Pressable
                        style={styles.single_container}
                        onPress={() => handleRemoveDependant(item?.user_id)}
                      >
                        <Trash
      ...
      <RemoveDependantDialog setShow={setAlertOn} show={alertOn} />
    </>
  );
}

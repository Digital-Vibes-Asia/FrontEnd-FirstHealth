    ...
    if (
      ...
      step1({
        data: {
          ...
          ic_number: formState.foreigner ? "" : formState.ic_num,
          ...
          are_u_foreigner: formState.foreigner ? 1 : 0,
          // isOthers: formState.isOthers,
          passport_no: formState.foreigner ? formState.ps_num : "",
        },
        url: UrlBase.STEP1,
      });
    } else {
    ...
    <>
      ...
      >
        <View style={{ marginHorizontal: "5%" }}>
          ...
          <View style={{ marginTop: "5%" }}>
            ...
            ></NumberInputBox>
            <GenderPick
              error={formState.foreigner_e}
              variable={"Yes"}
              variable2={"No"}
              madatory={true}
              title={"Are you a foreigner?"}
              desc={"Please choose"}
              value={formState.foreigner}
              value2={formState.non_foreigner}
              toggle={f_toggle}
            ></GenderPick>
            ...
            {formState?.foreigner && (
              <NameInputBox
                error={formState.ps_num_e}
                madatory={true}
                title={"Passport No."}
                desc={"Please enter your valid Passport No."}
                hint={"Your Passport No."}
                value={formState.ps_num}
                onChangeText={(param) => {
      ...
      <>
        {!formState.progressBar ? (
          <NextFhButton
            value={"Next, check coverage area"}
            onPress={() => {
              validation();
            }}
          ></NextFhButton>
